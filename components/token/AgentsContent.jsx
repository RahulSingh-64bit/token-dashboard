                ...
                {agents.map((agent, index) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          agent.permission === "Owner" ? "default" : "secondary"
                        }
                        className={
